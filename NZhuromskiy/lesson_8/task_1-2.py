...
class Auto:
    """создали класс auto с атрибутами brand, age, mark, color, weight
    атрибуты brand, age, mark являются обязательными"""
...
class Truck(Auto):
    """подкласс Truck наследует от суперкласса Auto
    у подкласса Truck появляется дополнительный обязательный атрибут max_load и дополнительный метод load"""
...
class Car(Auto):
    """подкласс Car наследует от суперкласса Auto
    у подкласса Car появляется дополнительный обязательный атрибут max_speed"""
